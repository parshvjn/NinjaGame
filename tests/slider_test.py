...
def sliderInit(sx,sy,width,height,buttonWidth,sliderBarHeight,maxValue,startValue,buttonColor = (255,255,255),sliderColor = (220,220,220),buttonBorderThickness = 1,sliderBorderThickness = 0):
        pygame.draw.rect(screen,screenColor,(sx,sy,width,height))
        pygame.draw.rect(screen,sliderColor,(sx,sy+height/2-sliderBarHeight/2,width,sliderBarHeight))
...
while True:
    ...
    if firstLoop == True:
        sliderInit(100,50,1000,50,25,10,100,50, (255,255,255),(220,220,220),1,0)
        sliderInit(100,120,1000,50,25,10,100,50,(255,255,255),(220,220,220),1,0)
        firstLoop = False
